...
/* 1. Check if the 'Fast Attack' action is possible. Implement a function named canExecuteFastAttack that takes a boolean value which indicates if the knight is awake. 
...
/* 2. Check if the 'Spy' action is possible. Implement a function named canSpy that takes three boolean values, indicating if the knight, archer and the prisoner, respectively, are awake. 
...
/*  3. Implement a function named canSignalPrisoner that takes two boolean values, indicating if the archer and the prisoner, respectively, are awake. 
...
function canSignalPrisoner(archerIsAwake, prisonerIsAwake) {
  ...
  /* 4. Implement a function named canFreePrisoner that takes four boolean values. The first three parameters indicate if the knight, 
...
function canFreePrisoner(
    ...
    if(knightIsAwake == false && archerIsAwake == false && prisonerIsAwake == false && petDogIsPresent == false) {
      ...
      return true;
    } if(prisonerIsAwake == true && knightIsAwake == false) {
      return true;
    } if(knightIsAwake == true) {
      return false;
    }
